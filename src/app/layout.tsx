...
export const metadata: Metadata = {
  title: "Matbakh Coffee Lab - Premium Coffee & Training | Madrid",
  description: "Discover exceptional specialty coffee and professional barista training at Matbakh in Madrid. Premium Colombian and Ethiopian beans, expert-led courses.",
  keywords: "coffee shop Madrid, barista training, specialty coffee, Colombian coffee, Ethiopian coffee, coffee lab",
  openGraph: {
    title: "Matbakh Coffee Lab - Premium Coffee & Training | Madrid",
    description: "Discover exceptional specialty coffee and professional barista training at Matbakh in Madrid.",
    siteName: "Matbakh Coffee Lab",
    type: "website",
    images: [{"url": "/placeholders/placeholder1.webp", "alt": "Matbakh coffee shop interior"}]
  },
  twitter: {
